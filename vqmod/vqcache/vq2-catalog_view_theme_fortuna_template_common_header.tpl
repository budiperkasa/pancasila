...
<!--[if IE 7]>                  <html class="ie7 no-js" <?php echo $fbOpengraphHeader; ?> lang="<?php echo $lang; ?>" dir="<?php echo $direction; ?>">     <![endif]-->
<!--[if lte IE 8]>              <html class="ie8 no-js" <?php echo $fbOpengraphHeader; ?> lang="<?php echo $lang; ?>" dir="<?php echo $direction; ?>">     <![endif]-->
<!--[if (gte IE 9)|!(IE)]><!--> <html class="not-ie no-js" <?php echo $fbOpengraphHeader; ?> lang="<?php echo $lang; ?>" dir="<?php echo $direction; ?>">  <!--<![endif]-->

<head>

	<base href="<?php echo $base; ?>" />
<?php echo $fbOpengraph; ?>
