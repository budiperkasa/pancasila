												...
												<tr>
													<td>
														<div class="customhelp"><?php echo $entry_extra_image_help; ?></div>
															<input type="hidden" name="slider[<?php echo $i; ?>][<?php echo $language_id; ?>][<?php echo $m; ?>][extra_image]" value="<?php echo $slider[$i][$language_id][$m]['extra_image']; ?>" id="slider_<?php echo $i; ?>_<?php echo $language_id; ?>_<?php echo $m; ?>_extra_image" />
