<section id="cart">
	...
	<div class="details">
		...
		<div class="content">
			...
			<div class="checkout">
				<a href="<?php echo $cart; ?>" class="button button-mini"><?php echo $text_cart; ?></a>
				<a href="<?php echo $checkout; ?>" class="button button-cart button-mini"><?php echo $text_checkout; ?></a>
			</div>
