				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="register-form" class="form-horizontal">
					...
					<fieldset class="subheading">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="postcode" id="postcode" value="<?php echo $postcode; ?>" title="<?php echo $this->language->get('error_postcode'); ?>" class="span6" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="country_id" id="country_id" title="<?php echo $this->language->get('error_country'); ?>" class="required span6" >
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="zone_id" id="zone_id" title="<?php echo $this->language->get('error_zone'); ?>" class="required span6">
								</select>
								<?php if ($error_zone) { ?>
					...
					<fieldset class="subheading">
						...
						<div class="control-group payment" id="payment-cheque">
							...
							<div class="controls">
								<input type="text" name="cheque" value="<?php echo $cheque; ?>" class="span6" />
							</div>
						</div>
						...
						<div class="control-group payment" id="payment-paypal">
							...
							<div class="controls">
								<input type="text" name="paypal" value="<?php echo $paypal; ?>" class="span6" />
							</div>
						</div>
					...
					<fieldset class="subheading">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="password" name="password" id="password" value="<?php echo $password; ?>" title="<?php echo $this->language->get('error_password'); ?>" class="password span6"  />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="password" name="confirm" id="confirm" value="<?php echo $confirm; ?>"  title="<?php echo $this->language->get('error_password'); ?>" class="password span6" />
