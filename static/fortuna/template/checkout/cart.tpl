				...
				<div class="row-fluid">
							...
							<div class="cart-module">
								...
								<div id="coupon" class="content">
									<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
										...
										&nbsp;
										<input type="submit" value="<?php echo $button_coupon; ?>" class="button button-inverse button-small" />
									</form>
								</div>
								<div id="voucher" class="content">
									<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
										...
										&nbsp;
										<input type="submit" value="<?php echo $button_voucher; ?>" class="button button-inverse button-small" />
									</form>
								</div>
								<div id="reward" class="content">
									<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
										...
										&nbsp;
										<input type="submit" value="<?php echo $button_reward; ?>" class="button button-inverse button-small" />
									</form>
								</div>
								<div id="shipping" class="content form-vertical">
									...
									<input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="button button-inverse button-small" />
					...
					<section id="total-cart" class="span6">
						...
						<div class="buttons">
							...
							<a href="<?php echo $continue; ?>" id="continue-shopping" class="button"><?php echo $button_shopping; ?></a>
						</div>
