				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="register-form" class="form-horizontal">
					...
					<fieldset class="subheading">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="tel" name="telephone" id="telephone" value="<?php echo $telephone; ?>" title="<?php echo $this->language->get('error_telephone'); ?>" class="required span6" required />
					...
					<fieldset class="subheading">
						...
						<div class="control-group" style="display: <?php echo (count($customer_groups) > 1 ? 'block' : 'none'); ?>;">
				  		...
				  		<div id="company-id-display" class="control-group">
							...
							<div class="controls">
								<input type="text" name="company_id" value="" title="<?php echo $this->language->get('error_company_id'); ?>" class="span6" />
						...
						<div id="tax-id-display" class="control-group">
							...
							<div class="controls">
								<input type="text" name="tax_id" value="" title="<?php echo $this->language->get('error_tax_id'); ?>" class="span6" />
								<?php if ($error_tax_id) { ?>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="country_id" id="country_id" title="<?php echo $this->language->get('error_country'); ?>" class="required span6" required >
