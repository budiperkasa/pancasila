				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="voucher" class="form-horizontal">
					...
					<div class="content">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="to_name" id="to_name" value="<?php echo $to_name; ?>" title="<?php echo $this->language->get('error_to_name'); ?>" class="required span6" required />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="email" name="to_email" id="to_email" value="<?php echo $to_email; ?>"  title="<?php echo $this->language->get('error_to_email'); ?>" class="required email span6" required />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="from_name" id="from_name" value="<?php echo $from_name; ?>" title="<?php echo $this->language->get('error_from_name'); ?>" class="required span6" required />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="email" name="from_email" id="from_email" value="<?php echo $from_email; ?>"  title="<?php echo $this->language->get('error_from_email'); ?>" class="required email span6" required />
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea name="message" id="message" cols="34" rows="6" class="span8"><?php echo $message; ?></textarea>
							</div>
						</div>
